...
- Use **Zoho CRM** beside a lead in **Next leads** (or **Lead queue** during a call) to open their CRM profile in a new tab. The link appears only when the lead has an imported `lead_id`. Sign in to Zoho with an account that has access to the profile.
