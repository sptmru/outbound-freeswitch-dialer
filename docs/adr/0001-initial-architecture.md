...
The product needs an outbound dialer with a Web UI softphone, FreeSWITCH, ESL, Docker, Node.js, and TypeScript. It must support click-to-call, manual voicemail drop, prerecorded audio playback into an active call, agent release once playback starts, call logging, and Maxo SIP trunk integration.
...
- PostgreSQL stores users, agents, calls, call legs, recordings, and call events.
