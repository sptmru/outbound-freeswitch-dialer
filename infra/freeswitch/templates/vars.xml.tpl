<include>
  <X-PRE-PROCESS cmd="set" data="domain=__FREESWITCH_DOMAIN__"/>
  <X-PRE-PROCESS cmd="set" data="external_sip_ip=__FREESWITCH_EXTERNAL_SIP_IP__"/>
  <X-PRE-PROCESS cmd="set" data="external_rtp_ip=__FREESWITCH_EXTERNAL_RTP_IP__"/>
  <X-PRE-PROCESS cmd="set" data="rtp_start_port=__FREESWITCH_RTP_START_PORT__"/>
  <X-PRE-PROCESS cmd="set" data="rtp_end_port=__FREESWITCH_RTP_END_PORT__"/>
